/**
 * Notifications Tab — Embedded notification center.
 * Content is rendered directly in the tab to prevent swipe-back gesture
 * from exiting the app (which happened when using Redirect).
 */
