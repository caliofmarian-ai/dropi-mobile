  ...
  return (
    <ScreenContainer className="px-4 pt-4">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity className="bg-surface border border-border rounded-xl p-3 mb-2 flex-row items-center" activeOpacity={0.7} onPress={() => router.push("/admin/monitoring" as any)}>
          <Text style={{ fontSize: 16, marginRight: 8 }}>📊</Text>
          <View style={{ flex: 1 }}>
            <Text className="text-sm font-medium text-foreground">System Monitoring</Text>
            <Text className="text-xs text-muted">WebSocket stats, push delivery, real-time health</Text>
          </View>
          <Text className="text-muted">→</Text>
        </TouchableOpacity>
