...
|---|---|---|---|---|---|
| `GAP-RO-ENTITY-LAUNCH` | Romania first-launch entity | Responsible operating entity, actual place of management, Romania/Ireland tax-residence implications, seller-of-record allocation, VAT/e-Factura treatment and exact CAEN activity set are not approved | Current company/fiscal/CAEN primary sources plus Romanian accountant/tax review and Ireland review where real management facts require it | RO Legal + Finance + Project Owner | Entity filing, invoice schema, tax assumptions, binding launch contracts |
