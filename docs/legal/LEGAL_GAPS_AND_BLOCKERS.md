...
| `GAP-RO-COOP-CURRENT-LAW` | Romania Cooperative Hub | Controlled current consolidated copies of Laws No. 566/2004 and No. 1/2005 could not be obtained from the official portal; indexed extracts and older copies cannot approve requirements | Archive the official current consolidations, reconcile amendments/effective dates and obtain a dated qualified Romanian cooperative-law opinion | RO Legal/Compliance | Legal-route approval, founder/member schema, formation, membership and governance design |
| `GAP-RO-COOP-FORMATION` | Romania Cooperative Hub | Exact route/degree/category, eligible founders and members, minimum count, capital/social parts, activities, CAEN Rev. 3 mapping and route-specific filing rules remain unapproved | Current primary sources, complete factual pilot scenarios, written lawyer/accountant mapping and ONRC/notary confirmation where the reviewer requires it | RO Legal + Finance | Route engine, hard-coded validation, document generation, automated filing and `DOCUMENTS_READY` semantics |
| `GAP-RO-COOP-GOVERNANCE` | Romania Cooperative Hub | Admission, withdrawal, suspension, exclusion, member register, notice, quorum, voting, mandates, elected terms and conflicts are not validated per route/statute/decision type | Dated counsel matrix citing current law and permitted statute configuration; approval of legal-versus-platform state separation and corrected state machines | RO Legal/Compliance | Membership activation, governance workspace, voting, resolutions and access derived from legal status |
| `GAP-RO-COOP-ELECTRONIC-ACTS` | Romania Cooperative Hub | ONRC electronic filing guidance and eIDAS do not establish route-specific validity of remote meetings, electronic votes, notices, mandates, minutes or resolutions; current Law No. 214/2024 copy is pending | Current Romanian electronic-signature law, current cooperative laws and a signed act-by-act matrix defining channel, identity, signature, delivery, quorum, original and retention rules | RO Legal + Security | Remote assembly, e-voting, e-signature/document workflows and legal evidence automation |
