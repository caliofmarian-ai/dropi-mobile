...
| `GAP-RO-PRIVACY-LAUNCH` | Romania Marketplace/merchant/order/payment/postal data | Launch-specific controller/processor roles, legal bases, retention, rights, legal hold, breach ownership and vendor terms are incomplete | GDPR + controlled Law 190/2018 + ANSPDCP/EDPB guidance + RoPA/data-flow/retention matrix + DPIA decision | Privacy/Security + RO Legal | Production personal-data collection beyond approved minimum, merchant verification retention, order/address/payment/postal/support data model |
