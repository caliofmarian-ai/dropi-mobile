...
| `GAP-RO-DEL-ROLE` | Romania parcel delivery | DROPi's exact status as postal provider, reseller/intermediary, or software platform is unresolved for each proposed flow | Current consolidated OUG 13/2013, Decision 925/2023 analysis, current ANCOM digital-reseller guidance, process map, written Romanian counsel/ANCOM position | RO Legal/Compliance | Company gate, contracts, partner model, document schema, integrated postal option, public delivery launch |
